...
\begin{itemize}
  ...
  \item Experiments
  \item Alternative route (optional)
  \item Conclusion
\end{itemize}
\end{frame}
...
\[
\supp(p)\subset\{p^\ast=\alpha\}\Rightarrow \langle u^\ast,p\rangle\ge0,
\qquad
\supp(p)\subset\{p^\ast=-\alpha\}\Rightarrow \langle u^\ast,p\rangle\le0.
\]
